...
public class WinnerController extends QuizPreferencesController {
	
    Store store = Store.getInstance();
    @FXML Label totalScoreWinner;
    @FXML FontAwesomeIconView muteButton;
    private boolean musicOn = true;

    @FXML
    public void initialize() {
        totalScoreWinner.setText("You scored: " + String.valueOf( store.totalScore ) );
